...
package com.github.leowing.utils;
...
public class AbViewUtil {
    ...
    public static void scaleView(View view) {
        ...
        if (null != params) {
            int width = INVALID;
            int height = INVALID;
            if (params.width != ViewGroup.LayoutParams.WRAP_CONTENT && params.width != ViewGroup.LayoutParams
                    .MATCH_PARENT) {
                width = params.width;
            }

            if (params.height != ViewGroup.LayoutParams.WRAP_CONTENT && params.height != ViewGroup.LayoutParams
                    .MATCH_PARENT) {
    ...
    public static void setViewSize(View view, int widthPixels, int heightPixels) {
        ...
        ViewGroup.LayoutParams params = view.getLayoutParams();
        if (params == null) {
            Log.e(TAG, "setViewSize出错,如果是代码new出来的View，需要设置一个适合的LayoutParams");
            return;
        }
